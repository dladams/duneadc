...
// June 2017
//
// Performance tree filler for DUNE17-test--extra test data for protoDUNE ADCs.
...
void filldbd17t(Index chip1, Index nchip, Index chan1=0, Index nchan =16,
                SampleIndex isam0 =0, SampleIndex nsam =0, bool fill =true) {
  const string myname = "filldb17t: ";
  if ( chan1 + nchan > 16 ) {
