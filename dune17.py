...
def dune17cSamples(group=0, isBad=False, isFail=False, skipSel=False, skipBad=True):
  ...
  sams2.append(pre + "141_0727")  # 7/28
  sams2.append(pre + "141_0728T09")  # 7/28
  sams2.append(pre + "141_0728T10")  # 7/28
...
def selectedChips():
  ...
  chips += [ 201, 111, 394, 376, 23, 11, 194, 392, 27, 133, 122, 24, 29, 21, 26, 106, 69, 371, 120, 370, 113, 372, 103, 66, 40, 374, 393, 16, 98, 63, 30, 104, 99, 368, 58, 6, 61, 10, 59]
  chips.sort()
  return chips
